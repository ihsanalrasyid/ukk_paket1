...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark">Catatan Perjalanan</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive mb-4">
            ...
            </select><button id="btnUrutkan" class="btn btn-dark">Urutkan</button></span></p>
        ...
        <a href="<?= base_url()."/isidata" ?>" class="btn btn-dark  float-right">
